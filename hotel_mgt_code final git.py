...
def resturantmenuview():
    ...
    if ch==1:
       ...
       if ch==1:
           print(" chole bathure--cost is 100rs")
           print(" dosa sambhar--cost is 100rs")
           print(" kachori--cost is 50rs")
           print(" litti chokha--cost is 150rs")
           print(" dal batti--cost is 150rs")
           print(" chicken tikka--cost is 250rs")
           print(" rogan josh--cost is 300rs")
           print(" kebabs--cost is 150rs")
           print(" samosa--cost is 50rs")
           print(" vada pav--cost is 50rs")
           print(" thukpa--cost is 200rs")
           print(" dahi balla--cost is 150rs")
           print(" khandvi--cost is 200rs")
       l='y'
       s=0
       while l=='y':
           ch=int(input("ENTER YOUR CHOICE "))
